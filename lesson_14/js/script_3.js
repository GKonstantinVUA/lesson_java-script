...
if (confirm('Почати тестування?')) {
	...
	const newArraySetSponsor = webSitesCompany.flatMap((itemArray)=>itemArray.sponsors.map((elemSponsor)=>elemSponsor.lastSponsorName + ' ' + elemSponsor.firstSponsorName))
	
	console.log(newArraySetSponsor);
