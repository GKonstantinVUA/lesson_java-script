...
if (confirm('Почати тестування?')) {
	...
	const totalNewPrices = dataList.reduce(
		(prevSumPrices, currentValuePrice) => prevSumPrices + currentValuePrice.price,
		0
	);
	
	document.write(`<div class="result__box-data">
			<div class="result__name-value"> Загальна вартість: <span class="result__answer-value">${totalNewPrices} </span>грн.</div></div>`);
}