...
if (confirm('Почати тестування?')) {
	...
	const viewProductFilter = dataList.filter((paramSellStatus) => paramSellStatus.sell_status === "available");
	console.log(viewProductFilter)
	...
	//# Варіант #2
// let viewProductFilter = []

// for (const param of dataList) {
// 	if (param.sell_status === "available") viewProductFilter.push(param)
// 	}
// 	console.log(viewProductFilter)
