...
if (confirm('Почати тестування?')) {
	...
	const changeProductPrice = dataList.reduce((prevParamChange, currentValuePrice) => currentValuePrice.price < currentValuePrice.old_price ? prevParamChange + 1 : prevParamChange, 0)
	
	document.write(`<div class="result__box-data">
			<div class="result__name-value"> Кількість товарів, у яких зменшилась ціна: <span class="result__answer-value">${changeProductPrice}</span> одн.</div></div>`)
}