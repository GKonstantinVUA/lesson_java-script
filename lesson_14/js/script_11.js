...
if (confirm('Почати тестування?')) {
	...
	let productsFilter = dataList
		.filter((paramSellStatus) => paramSellStatus.sell_status === 'available')
		.map((paramSelection) => ({
			id: paramSelection.id,
			price: paramSelection.price,
			old_price: paramSelection.old_price,
			usd_price: paramSelection.usd_price,
		}));
